 ...
 *    Author(s):      Koroteev Dmitry
 *    Created:        10-2007
 *    Description:    CRC16 calculation tools (header file)
 *
 */
...
#include <vu_tools/vu_tools.h> /* basic integer types */

/* Table for polinom x^16+x^15+x^2+1 */
static const u16 crc16_8005_table[256]=
{
...
/* The CRC calculation using simulated shift register with feedback */
u16 crc16_sr(
                 u16   init,           /* initial register value */
...
/* Build table for CRC16 fast calculation */
void crc16_build_table(
                            u16 polinom, /* polinom */
                            u16 *table  /* CRC16 fast calulation table */
                      );

/*
 * Calculate CRC16 using table.
 */
u16 crc16(
              u16            init,     /* initialization value */
              const u16      xor_out,  /* finalization value */
              const char*       data,  /* data buffer */
              int            len,      /* size of buffer */
              const u16*     table     /* CRC16 fast calc table */
         );
